import os
import pandas as pd
from alpenglow.experiments import BatchAndOnlineFactorExperiment
...
model_experiment = BatchAndOnlineFactorExperiment(
    top_k=k,
    seed=seed,
    dimension=dim,
    learning_rate=0.14,
...
rankings.to_csv(output_dir + "/bomf_%s.csv" % str(K))
