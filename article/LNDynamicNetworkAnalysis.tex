...
\section{LN's evolution}
\subsection{Macroscopic evolution}
...
\begin{figure}[H]
	...
	\caption{LN follows the Densification Power Law relation with exponent $a=1.55634117$}
\end{figure}

\subsection{Microscopic evolution}
\section{Link prediction}
\section{Fee (sub)optimality}
\section{Conclusion}
